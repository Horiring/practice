...
<%@ page language="java" contentType="text/html; charset=utf-8" 
	pageEncoding="utf-8" %>
<link href="<c:url value='/resources/css/reesrvationList.css'/>" rel="stylesheet"/>
<link href="<c:url value='/resources/css/memberinfo.css'/>" rel="stylesheet"/>
      ...
      <div class="default_width container-fluid ">        	
        <c:choose>
        	<c:when test="${bu_email != null}"> <!-- 사업자 로그인 -->
        		<img class="header-image" alt="logo" src="<c:url value='/resources/img/colorlogo.png'/>" style="width:120px;"
